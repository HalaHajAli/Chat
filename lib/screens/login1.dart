...
import 'package:chatt/screens/forgetpass.dart';
                ...
                decoration: InputDecoration(
                  ...
                  border: OutlineInputBorder(
                    ...
                    borderSide: BorderSide(
                        color:
                            usernameError.isNotEmpty ? Colors.red : Color.fromARGB(255, 91, 165, 129)),
                  ),
              ...
              child: TextFormField(
                decoration: InputDecoration(
                  ...
                  border: OutlineInputBorder(
                    ...
                    borderSide: BorderSide(
                        color:
                            passwordError.isNotEmpty ? Colors.red : Color.fromARGB(255, 91, 165, 129)),
                  ),
              ...
              onPressed: () async {
                ...
                if (username.isNotEmpty && password.isNotEmpty) {
                  try {
                    ...
                    if (user != null) {
                      Navigator.pushNamed(context, ServicePage.screenRoute,
                          arguments: widget.userType);
                    }
                  } catch (e) {
                    print(e);
                    // Set error messages based on the authentication error if needed
                    setState(() {
